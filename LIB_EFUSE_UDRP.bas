Attribute VB_Name = "LIB_EFUSE_UDRP"
Option Explicit

Public Function auto_eFuse_CMPP_Parsing_HLlimit(ByVal FuseType As eFuseBlockType)

On Error GoTo errHandler
    Dim funcName As String:: funcName = "auto_eFuse_CMPP_Parsing_HLlimit"
