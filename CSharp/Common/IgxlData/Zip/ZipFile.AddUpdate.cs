...
namespace IgxlData.Zip
{
    public partial class ZipFile
    {
        ...
        ///     </para>
        ///     <para>
        ///         For <c>ZipFile</c> properties including <see cref="Encryption" />,
        ///         <see
        ///             cref="Password" />
        ///         , <see cref="SetCompression" />,
        ///         <see
        ///             cref="ProvisionalAlternateEncoding" />
        ///         , <see cref="ExtractExistingFile" />,
        ...
        public void RemoveEntries(ICollection<ZipEntry> entriesToRemove)
        {
            ...
            foreach (var e in entriesToRemove) RemoveEntry(e);
        }
        ...
        ///     </para>
        ///     <para>
        ///         For <c>ZipFile</c> properties including
        ///         <see
        ///             cref="Encryption" />
        ///         , <see cref="Password" />,
        ///         <see
        ...
        ///         , their respective values at the
            ...
            if (preserveDirHierarchy)
                foreach (var f in fileNames)
                {
                    ...
                    if (directoryPathInArchive != null)
                    {
                        ...
                        var s = Path.GetFullPath(Path.Combine(directoryPathInArchive, Path.GetDirectoryName(f)));
                        AddFile(f, s);
                    }
                    else
                    {
        ...
        public ZipEntry AddUpdateEntry(string entryName, string content)
        {
        ...
        ///         should use the
        ///         <see
        ///             cref="AddEntry(string, IgxlData.Packaging.DotNetZip.OpenDelegate, IgxlData.Packaging.DotNetZip.CloseDelegate)" />
        ///         overload.
        ///     </para>
        ///     <para>
        ///         For <c>ZipFile</c> properties including <see cref="Encryption" />,
        ...
        ///         not issue any SaveProgress events with <c>EventType</c> =
        ///         <see
        ...
        ///         including
        ///         <see cref="ZipProgressEventType.Saving_Started">
        ///             Saving_Started
        ///         </see>
        ///         ,
        ...
        ///         DotNetZip forums and vote up
        ///         <see
        ///             href="http://dotnetzip.codeplex.com/workitem/13686">
        ///             the Workitem
        ///             tracking this issue
        ///         </see>
        ///         .
        ...
        ///     given file name and directory path, if it exists, and then calling
        ///     <see
        ///         cref="AddEntry(string,IgxlData.Zip.WriteDelegate)" />
        ///     .  See the
        ///     documentation for that method for further explanation.
        /// </remarks>
        /// <param name="entryName">
        ...
        ///     given file name and directory path, if it exists, and then calling
        ///     <see
        ///         cref="AddEntry(string,IgxlData.Zip.OpenDelegate,IgxlData.Zip.CloseDelegate)" />
        ///     .  See the
        ///     documentation for that method for further explanation.
        /// </remarks>
        /// <param name="entryName">
            ...
            int level)
        {
            ...
            var dirForEntries = rootDirectoryPathInArchive;
            ZipEntry baseDir = null;

            if (level > 0)
            {
                var f = directoryName.Length;
