...
namespace IgxlData.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///         LastModified value on an entry, to an arbitrary value.
        ///         <see
        ///             cref="System.DateTime" />
        ///         values with a <see cref="System.DateTimeKind" />
        ...
        ///             Zip specification
        ///         </see>
        ///         describes how times are stored in the zip file,
        ...
        ///         saving time.  Raymond Chen
        ///         <see
        ///             href="http://blogs.msdn.com/oldnewthing/archive/2003/10/24/55413.aspx">
        ///             provides
        ///             some good context
        ///         </see>
        ///         .
        ...
        ///             specification
        ///         </see>
        ///         .  When getting this property, the value may be
        ...
        ///         2-second precision, because, c'mon,
        ///         <em>
        ///             who is ever going to need better
        ///             resolution than THAT?
        ///         </em>
        ///         And so ZIP files, regardless of the platform on
        ///         which the zip file was created, store file times in exactly
        ///         <see
        ///             href="http://www.vsft.com/hal/dostime.htm">
        ///             the same format that DOS used
        ///             in 1989
        ///         </see>
        ///         .
        ///     </para>
        ...
        ///         <c>ModifiedTime</c> is not. (The other times stored in the
        ///         <em>
        ///             NTFS
        ///             times extension
        ///         </em>
        ///         , <c>CreationTime</c> and <c>AccessedTime</c> also
        ...
        ///         quantities, it's more efficient to use the
        ///         <see
        ///             cref="SetEntryTimes(DateTime, DateTime, DateTime)" />
        ///         method.  Those
        ///         changes are not made permanent in the zip file until you call
        ///         <see
        ///             cref="ZipFile.Save()" />
        ...
        ///         And reading it was so enjoyable, too!  Well, in appreciation,
        ///         <see
        ///             href="http://cheeso.members.winisp.net/DotNetZipDonate.aspx">
        ///             maybe you
        ///             should donate
        ///         </see>
        ///         ?
        ...
        ///         <see
        ///             cref="ModifiedTime" />
        ///         , <see cref="CreationTime" /> and
        ///         <see
        ///             cref="AccessedTime" />
        ///         properties.
        ///     </para>
        ///     <para>
        ///         When this method is called, if both
        ///         <see
        ///             cref="EmitTimesInWindowsFormatWhenSaving" />
        ///         and
        ///         <see
        ///             cref="EmitTimesInUnixFormatWhenSaving" />
        ///         are false, then the
        ...
        ///     </para>
        ///     <para>
        ///         When adding an entry from a file or directory, the Creation (
        ///         <see
        ///             cref="CreationTime" />
        ///         ), Access (<see cref="AccessedTime" />), and Modified
        ...
        ///             zip specification
        ///         </see>
        ///         describes multiple ways to format these times in a
        ...
        ///     </para>
        ///     <para>
        ///         The times stored are taken from <see cref="ModifiedTime" />,
        ///         <see
        ///             cref="AccessedTime" />
        ///         , and <see cref="CreationTime" />.
        ///     </para>
        ///     <para>
        ///         This property is not mutually exclusive from the
        ///         <see
        ///             cref="ZipEntry.EmitTimesInUnixFormatWhenSaving" />
        ///         property.  It is
        ...
        ///         <see
        ///             cref="ZipFile.EmitTimesInWindowsFormatWhenSaving">
        ...
        ///         This property is not mutually exclusive from the
        ///         <see
        ///             cref="ZipEntry.EmitTimesInWindowsFormatWhenSaving" />
        ///         property.  It is
        ///         possible that a zip entry can embed the timestamps in both forms, one
        ///         form, or neither.  But, there are no guarantees that a program running on
        ///         Mac or Linux will gracefully handle NTFS Formatted times, or that a
        ...
        ///         Normally you will use the
        ///         <see
        ///             cref="ZipFile.EmitTimesInUnixFormatWhenSaving">
        ///             ZipFile.EmitTimesInUnixFormatWhenSaving
        ///         </see>
        ...
        /// <seealso cref="EmitTimesInWindowsFormatWhenSaving" />
        /// <seealso cref="EmitTimesInUnixFormatWhenSaving" />
        internal ZipEntryTimestamp Timestamp { get; private set; }
        ...
        ///     </para>
        ///     <para>
        ///         When it is set, the value of this property may be different than
        ///         <see
        ///             cref="FileName" />
        ///         , which is the path used in the archive itself.  If you
        ...
        ///         file, via a call to <see cref="ZipFile.AddFile(String,String)" /> or
        ///         <see
        ///             cref="ZipFile.AddItem(String,String)" />
        ///         , or a related overload, the value
        ...
        ///   string)" /> or one of the similar
        ///         overloads.  In this case, the value of
        ...
        ///             specification
        ///         </see>
        ///         , for compatibility with Unix(tm) and ... get
        ///         this.... Amiga!
        ///     </para>
        ///     <para>
        ///         If an application reads a <c>ZipFile</c> via
        ///         <see
        ///             cref="ZipFile.Read(String)" />
        ///         or a related overload, and then explicitly
        ...
        ///         cannot rename the entry within the context of a <c>foreach</c> (
        ///         <c>
        ///             For
        ///             Each
        ///         </c>
        ///         in VB) loop, because of the way the <c>ZipFile</c> stores
        ///         entries.  If you need to enumerate through all the entries and rename one
        ///         or more of them, use
        ///         <see
        ///             cref="ZipFile.EntriesSorted">
        ///             ZipFile.EntriesSorted
        ///         </see>
        ///         as the
        ///         collection.  See also,
        ///         <see
        ///             cref="ZipFile.GetEnumerator()">
        ///             ZipFile.GetEnumerator()
        ///         </see>
        ///         .
        ///     </para>
        /// </remarks>
        ...
        ///         with content obtained from hundreds of streams, added through
        ///         <see
        ...
        ///     <para>
        ///         To avoid this, call
        ///         <see cref="ZipFile.AddEntry(String, IgxlData.Packaging.DotNetZip.OpenDelegate,
        ///   CloseDelegate)" /> and
        ///         specify delegates that open and close the stream at
        ///         the time of Save.
        ///     </para>
        ///     <para>
        ///         Setting the value of this property when the entry was not added from a
        ///         stream (for example, when the <c>ZipEntry</c> was added with
        ///         <see
        ///             cref="ZipFile.AddFile(String)" />
        ///         or
        ///         <see
        ///             cref="ZipFile.AddDirectory(String)" />
        ///         , or when the entry was added by
        ...
        ///         more of the <c>ZipEntry</c> instances from streams, using the
        ///         <see
        ///             cref="ZipFile.AddEntry(string, System.IO.Stream)" />
        ///         method.  At the time
        ...
        ///         property, typically within the SaveProgress event (event type:
        ///         <see
        ///             cref="ZipProgressEventType.Saving_BeforeWriteEntry" />
        ///         ) for that entry.
        ///     </para>
        ///     <para>
        ///         The application will later want to call Close() and Dispose() on that
        ///         stream.  In the SaveProgress event, when the event type is
        ///         <see
        ...
        /// <remarks>
        ///     <para>
        ///         This is a readonly property, indicating the version of
        ///         <a
        ///             href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT">
        ///             the Zip
        ///             specification
        ///         </a>
        ///         that the extracting tool or library must support to
        ...
        ///                     specification
        ///                 </a>
        ///                 describing the Strong Encryption Specification for
        ///                 details.
        ///             </description>
        ///         </item>
        ///         <item>
        ...
        /// <remarks>
        ///     <para>
        ///         <see href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT">
        ///             The
        ///             Zip specification
        ///         </see>
        ///         allows a variety of compression methods.  This
        ...
        internal CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (short) CompressionMethod.None)
        ...
        ///     <para>
        ///         The value is a
        ///         <see href="http://en.wikipedia.org/wiki/CRC32">
        ///             32-bit
        ///             CRC
        ///         </see>
        ///         using 0xEDB88320 for the polynomial. This is the same CRC-32 used in
        ...
        ///         actually used (which will have been true if the
        ///         <see
        ///             cref="Password" />
        ///         was set and the <see cref="Encryption" /> property
        ...
        ///         saved. When setting this property, you must also set a
        ///         <see
        ///             cref="Password" />
        ///         on the entry.  If you set a value other than
        ///         <see
        ///             cref="EncryptionAlgorithm.None" />
        ///         on this property and do not set a
        ///         <c>Password</c> then the entry will not be encrypted. The <c>ZipEntry</c>
        ///         data is encrypted as the <c>ZipFile</c> is saved, when you call
        ///         <see
        ///             cref="ZipFile.Save()" />
        ///         or one of its cousins on the containing
        ...
        ///         and libraries, such as WinZip or Xceed, typically support
        ///         <em>
        ///             a
        ///             subset
        ///         </em>
        ///         of the algorithms specified by PKWare. These tools can
        ...
        ///         encryption, sometimes called Zip 2.0 encryption, as
        ///         <see
        ///             href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT">
        ///             specified
        ///             by PKWare
        ///         </see>
        ///         , but this encryption is considered weak and
        ...
        ///     </para>
        ///     <para>
        ///         The <see cref="ZipFile" /> class also has a
        ///         <see
        ///             cref="ZipFile.Encryption" />
        ///         property.  In most cases you will use
        ...
        ///         <see cref="ZipFile.Save()" /> operation, or to decrypt during the
        ///         <see
        ///             cref="Extract()" />
        ///         or <see cref="OpenReader()" /> operation.  If you set
        ...
        ///         specification,
        ///         <see href="http://en.wikipedia.org/wiki/Advanced_Encryption_Standard">
        ///             AES
        ///             Encryption
        ///         </see>
        ///         uses a standard, strong, tested, encryption
        ...
        /// <remarks>
        ///     <para>
        ///         Errors can occur within a call to
        ///         <see
        ///             cref="ZipFile.Save()">
        ///             ZipFile.Save
        ///         </see>
        ///         , as the various files contained
        ...
        ///         instances.  Instead, you will set the
        ///         <see
        ///             cref="ZipFile.ZipErrorAction">
        ///             ZipFile.ZipErrorAction
        ///         </see>
        ///         property on
        ...
        ///         encoded with UTF-8, as described in
        ///         <see
        ///             href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT">
        ///             the Zip
        ///             specification
        ///         </see>
        ///         , if necessary. "Necessary" means, the filename or
        ...
        ///         to <c>System.Text.Encoding.UTF8</c>.
        ///     </para>
        ///     <para>
        ...
        internal static ZipEntry CreateForJitStreamProvider(string nameInArchive, OpenDelegate opener,
        ...
        ///         Windows,
        ///         <see
        ///             href="http://www.codeproject.com/KB/cs/GetFileTypeAndIcon.aspx">
        ///             you
        ...
        private void SetFdpLoh()
        {
            ...
            var origPosition = ArchiveStream.Position;
            try
            {
    ...
    ///         ZIP Specification
    ///     </see>
    ///     describes a number of distinct
    ...
    internal enum CompressionMethod
    {
        ...
        /// <summary>
        ///     DEFLATE compression, as described in
        ///     <see
        ///         href="http://www.ietf.org/rfc/rfc1951.txt">
        ///         IETF RFC
        ///         1951
        ///     </see>
        ///     .  This is the "normal" compression used in zip
