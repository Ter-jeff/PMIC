...
namespace IgxlData.Zip
{
    ...
    ///             specification
    ///         </see>
    ///         , and are considered to be "standard".  Zip archives
    ...
    ///     </para>
    ///     <para>
    ///         In case you care: According to
    ///         <see
    ///             href="http://www.winzip.com/aes_info.htm">
    ///             the WinZip specification
    ///         </see>
    ///         , the
    ///         actual AES key used is derived from the <see cref="ZipEntry.Password" /> via an
    ///         algorithm that complies with
    ///         <see
    ...
    ///         <see
    ///             href="http://www.redkestrel.co.uk/Articles/RandomPasswordStrength.html">
    ///             this
    ///             article.
    ///         </see>
    ///     </para>
