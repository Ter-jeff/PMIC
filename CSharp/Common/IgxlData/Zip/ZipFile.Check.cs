    ...
    public partial class ZipFile
    {
        ...
        public string Info
        {
            get
            {
                ...
                if (_versionMadeBy != 0) builder.Append(string.Format("  version made by: 0x{0:X4}\n", _versionMadeBy));
                ...
                builder.Append("\n");
                foreach (var entry in _entries.Values) builder.Append(entry.Info);
        ...
        ///     </para>
        ///     <para>
        ///         Developers using COM can use the
        ///         <see
        ///             cref="ComHelper.CheckZip">
        ///             ComHelper.CheckZip(String)
        ///         </see>
        ///         method.
        ///     </para>
        /// </remarks>
...

        {
            ...
            try
            {
                ...
                foreach (var e2 in zip2)
                    if (e1.FileName == e2.FileName)
                    {
                        if (e1._RelativeOffsetOfLocalHeader != e2._RelativeOffsetOfLocalHeader)
                        {
                            ...
                            if (writer != null)
                                writer.WriteLine(
                                    "{0}: mismatch in RelativeOffsetOfLocalHeader  (0x{1:X16} != 0x{2:X16})",
                ...
                {
                    var newFileName = Path.GetFileNameWithoutExtension(zipFileName);
        ...
        ///         Developers using COM can use the
        ///         <see
        ///             cref="ComHelper.FixZipDirectory">
        ///             ComHelper.FixZipDirectory(String)
        ///         </see>
        ///         method.
        ///     </para>
        /// </remarks>
