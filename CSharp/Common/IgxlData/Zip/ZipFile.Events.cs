...
namespace IgxlData.Zip
{
    public partial class ZipFile
    {
        ...
        {
            get { return Name != null ? Name : "(stream)"; }
        }
        ...
        ///         <see
        ///             cref="IgxlData.Packaging.DotNetZip.SaveProgressEventArgs" />
        ///         parameter are set.  The following
        ...
        ///         <see cref="IgxlData.Packaging.DotNetZip.ReadProgressEventArgs" /> parameter are set.  The following table
        ...
        ///         Depending on the particular event, different properties on the
        ///         <see
        ///             cref="IgxlData.Packaging.DotNetZip.ExtractProgressEventArgs" />
        ///         parameter are set.  The following
        ///         table summarizes the available EventTypes and the conditions under
        ///         which this event handler is invoked with a
        ...
        private void OnExtractEntry(int current, bool before, ZipEntry currentEntry, string path)
        {
            ...
            if (ep != null)
            {
                var e = new ExtractProgressEventArgs(ArchiveNameForEvent, before, _entries.Count, current, currentEntry,
                    path);
                ep(this, e);
                if (e.Cancel)
        ...
        ///     </para>
        ///     <para>
        ///         In the error handler method, you need to set the
        ///         <see
        ///             cref="ZipEntry.ZipErrorAction" />
        ///         property on the
