...
namespace IgxlData.Zip
{
    ...
    internal class ZipOutputStream : Stream
    {
        ...
        ///     <see
        ///         cref="ZipOutputStream(System.IO.Stream)">
        ...
        public string Password
        {
            set
            {
                ...
                else if (_encryption == EncryptionAlgorithm.None) _encryption = EncryptionAlgorithm.PkzipWeak;
            }
        }
        ...
        public bool UseUnicodeAsNecessary
        {
            get
            {
                return AlternateEncoding == Encoding.UTF8 &&
        ...
        /// </summary>
        public ZipOption AlternateEncodingUsage { get; set; } = ZipOption.Never;

        /// <summary>
        ///     The default text encoding used in zip archives.  It is numeric 437, also
        ///     known as IBM437.
        /// </summary>
        /// <seealso cref="OfficeOpenXml.Packaging.Ionic.Zip.ZipFile.ProvisionalAlternateEncoding" />
        public static Encoding DefaultEncoding
        {
            get { return Encoding.GetEncoding("IBM437"); }
        }
        ...
        {
            return string.Format("ZipOutputStream::{0}(leaveOpen({1})))", Name, _leaveUnderlyingStreamOpen);
        }
        ...
        private void InsureUniqueEntry(ZipEntry ze1)
        {
            ...
            {
                _exceptionPending = true;
                throw new ArgumentException(string.Format("The entry '{0}' already exists in the zip archive.",
                    ze1.FileName));
            }
        }
        ...
        private void _InitiateCurrentEntry(bool finishing)
        {
            ...
            if (!_currentEntry.IsDirectory)
            {
                ...
                _currentEntry.PrepOutputStream(OutputStream,
                    finishing ? 0 : -1,
                    out _outputCounter,
                    out _encryptor,
                    out _deflater,
        ...
        private void _FinishCurrentEntry()
        {
            if (_currentEntry != null)
            {
                ...
                _currentEntry.FinishOutputStream(OutputStream, _outputCounter, _encryptor, _deflater,
                    _entryOutputStream);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (disposing) // not called from finalizer
                ...
                {
                    _FinishCurrentEntry();
                    _directoryNeededZip64 = ZipOutput.WriteCentralDirectoryStructure(OutputStream,
                    ...
                    var cs = OutputStream as CountingStream;
                    if (cs != null)
                    {
    ...
    internal class ZipContainer
    {
        ...
        public ParallelDeflateOutputStream ParallelDeflater
        {
            ...
            set
            {
                if (ZipFile != null) ZipFile.ParallelDeflater = value;
                else if (ZipOutputStream != null) ZipOutputStream.ParallelDeflater = value;
            }
        }
