...
namespace IgxlData.Zip
{
    public partial class ZipFile
    {
        ...
        ///         before the call to <c>Save</c>. See the
        ///         <see
        ///             cref="ZipEntry.InputStream" />
        ///         property for more discussion of the
        ...
        /// <exception cref="IgxlData.Packaging.DotNetZip.BadStateException">
        ...
        public void Save()
        {
            try
            {
                ...
                OutputUsedZip64 = thisSaveUsedZip64;
...
#else
                        tmpName = Name + "." + Path.GetRandomFileName();
#endif
        ...
        {
            foreach (var e in c) e.NotifySaveComplete();
        }
        ...
        public void Save(string fileName)
        {
            ...
            else _readName = Name; // workitem 13915
    ...
    internal static class ZipOutput
    {
            ...
            ZipContainer container)
        {
            ...
            if (startSegment != 0)
            {
                ...
                var thisSegment = (ushort) zss.ComputeSegment(a2.Length);
                var i = 4;
                // number of this disk
            ...
            ZipContainer container)
        {
            ...
            else
            {
                ...
                if (commentLength + i + 2 > bytes.Length) commentLength = (short) (bytes.Length - i - 2);
                ...
                if (commentLength != 0)
                {
                    ...
                    for (j = 0; j < commentLength && i + j < bytes.Length; j++) bytes[i + j] = block[j];
                    i += j;
                }
            }
            ...
            uint numSegments)
        {
            ...
            var x2 = numSegments == 0 ? 0 : numSegments - 1;
