...
namespace IgxlData.Zip
{
    public partial class ZipEntry
    {
        ...
        /// <seealso cref="Extract(IgxlData.Zip.ExtractExistingFileAction)" />
        /// <remarks>
        ///     <para>
        ...
        ///         existing file is determined by the <see cref="ExtractExistingFile" /> property.
        ///     </para>
        ///     <para>
        ...
        /// <remarks>
        ///     <para>
        ///         The caller can specify any write-able stream, for example a
        ///         <see
        ///             cref="System.IO.FileStream" />
        ///         , a
        ///         <see
        ...
        /// <seealso cref="ZipEntry.ExtractExistingFile" />
        /// <seealso cref="Extract(string,IgxlData.Zip.ExtractExistingFileAction)" />
        /// <example>
        ...
        ///         <see cref="Extract(string,IgxlData.Zip.ExtractExistingFileAction)" />.
        ///     </para>
        ///     <para>
        ///         See the remarks on the <see cref="LastModified" /> property, for some
        ...
        /// </overloads>
        /// <seealso cref="ZipEntry.ExtractExistingFile" />
        /// <seealso cref="ExtractWithPassword(IgxlData.Zip.ExtractExistingFileAction,string)" />
        /// <remarks>
        ///     <para>
        ///         Existing entries in the filesystem will not be overwritten. If you
        ///         would like to force the overwrite of existing files, see the
        ///         <see
        ///             cref="ZipEntry.ExtractExistingFile" />
        ///         property, or call
        ///         <see
        ///             cref="ExtractWithPassword(IgxlData.Zip.ExtractExistingFileAction,string)" />
        ///         .
        ///     </para>
        ///     <para>
        ///         See the remarks on the <see cref="LastModified" /> property for some
        ...
        /// </summary>
        /// <seealso cref="ZipEntry.ExtractExistingFile" />
        /// <seealso cref="ExtractWithPassword(string,IgxlData.Zip.ExtractExistingFileAction,string)" />
        /// <remarks>
        ///     <para>
        ///         Existing entries in the filesystem will not be overwritten. If you
        ///         would like to force the overwrite of existing files, see the
        ...
        /// </param>
        /// <param name="password">The Password to use for decrypting the entry.</param>
        internal void ExtractWithPassword(string baseDirectory, ExtractExistingFileAction extractExistingFile,
            string password)
        {
            ExtractExistingFile = extractExistingFile;
            InternalExtract(baseDirectory, null, password);
        ...
        ///         <see
        ///             cref="CrcCalculatorStream" />
        ///         .  Use it as you would any
        ///         stream for reading.  When an application calls
        ///         <see
        ///             cref="Stream.Read(byte[], int, int)" />
        ///         on that stream, it will
        ...
        internal Stream GetExtractDecryptor(Stream input)
        {
            ...
            if (_Encryption_FromZipFile == EncryptionAlgorithm.PkzipWeak)
                ...
                input2 =
 new WinZipAesCipherStream(input, _aesCrypto_forExtract, _CompressedFileDataSize, CryptoMode.Decrypt);
#endif
