...
namespace IgxlData.Zip
{
    ...
    ///         writes zip files, as defined in the
    ///         <see
    ...
    ///         <c>Stream</c> type to write the zip file, you may want to consider the
    ///         <see
    ...
    ///     </list>
    ///     <para>
    ///         Be aware that the <c>ZipFile</c> class implements the
    ///         <see
    ///             cref="System.IDisposable" />
    ///         interface.  In order for <c>ZipFile</c> to
        ...
        IDisposable
    {
        ...
        ///     </para>
        ///     <para>
        ///         This flag is effective only when calling
        ///         <see
        ///             cref="Initialize(string)" />
        ///         . Normally you would read a ZipFile with the
        ...
        ///     .
        /// </remarks>
        public CompressionStrategy Strategy { get; set; } = CompressionStrategy.Default;
        ...
        ///     </para>
        ///     <para>
        ///         As with some other properties on the <c>ZipFile</c> class, like
        ///         <see
        ///             cref="Password" />
        ///         , <see cref="Encryption" />, and
        ///         <see
        ///             cref="ZipErrorAction" />
        ///         , setting this property on a <c>ZipFile</c>
        ...
        internal CompressionMethod CompressionMethod { get; set; } = CompressionMethod.Deflate;
        ...
        ///         <see
        ///             cref="ZipEntry.CreationTime" />
        ///         ), Access (
        ///         <see
        ///             cref="ZipEntry.AccessedTime" />
        ///         ), and Modified (
        ///         <see
        ///             cref="ZipEntry.ModifiedTime" />
        ///         ) times for the given entry are
        ...
        ///         while I believe
        ///         <see href="http://www.info-zip.org/">
        ///             the Infozip
        ///             tools
        ///         </see>
        ///         can read the Unix format timestamps. Some tools and libraries
        ///         may be able to read only one or the other. DotNetZip can read or write
        ///         times in either or both formats.
        ///     </para>
        ///     <para>
        ///         The times stored are taken from <see cref="ZipEntry.ModifiedTime" />,
        ///         <see
        ///             cref="ZipEntry.AccessedTime" />
        ///         , and <see cref="ZipEntry.CreationTime" />.
        ///     </para>
        ///     <para>
        ...
        ///     </para>
        ///     <para>
        ///         This property is not mutually exclusive of the
        ///         <see
        ///             cref="EmitTimesInUnixFormatWhenSaving" />
        ///         property. It is possible and
        ///         legal and valid to produce a zip file that contains timestamps encoded in
        ///         the Unix format as well as in the Windows format, in addition to the
        ///         <see
        ///             cref="ZipEntry.LastModified">
        ///             LastModified
        ///         </see>
        ...
        /// <summary>
        ///     Indicates whether verbose output is sent to the
        ///     <see
        ///         cref="StatusMessageTextWriter" />
        ///     during <c>AddXxx()</c> and
        ///     <c>ReadXxx()</c> operations.
        /// </summary>
        /// <remarks>
        ///     This is a <em>synthetic</em> property.  It returns true if the
        ///     <see
        ///         cref="StatusMessageTextWriter" />
        ///     is non-null.
        /// </remarks>
        ...
        {
            get { return StatusMessageTextWriter != null; }
        }
        ...
        ///         </see>
        ///         provides for encoding file names and file
        ...
        ///         application can specify an arbitrary encoding via the
        ///         <see
        ///             cref="ProvisionalAlternateEncoding" />
        ///         property.  Setting the encoding
        ...
        /// <remarks>
        ///     <para>
        ///         When creating a zip file, the default value for the property is
        ///         <see
        ...
        ///         archive use ZIP64 extensions or not?  To learn this, check the
        ///         <see
        ///             cref="OutputUsedZip64" />
        ///         property, after calling <c>Save()</c>.
        ///     </para>
        ///     <para>
        ...
        ///         archive may use ZIP64 even when not required if the
        ///         <see
        ///             cref="ZipFile.UseZip64WhenSaving" />
        ///         property is set to
        ///         <see
        ///             cref="Zip64Option.Always" />
        ///         , or if the
        ///         <see
        ///             cref="ZipFile.UseZip64WhenSaving" />
        ///         property is set to
        ///         <see
        ///             cref="Zip64Option.AsNecessary" />
        ///         and the output stream was not
        ...
        ///         <c>UseZip64WhenSaving</c> property was set to
        ///         <see
        ///             cref="Zip64Option.AsNecessary" />
        ...
        ///             zip specification
        ///         </see>
        ///         , PKWare describes two options for encoding
        ...
        ///         when encoding the <see cref="ZipEntry.FileName" /> and
        ///         <see
        ///             cref="ZipEntry.Comment" />
        ///         for each <c>ZipEntry</c> in the zip file, for
        ...
        ///         filenames that have Danish characters.  If you use
        ///         <see
        ///             cref="ProvisionalAlternateEncoding" />
        ///         equal to "iso-8859-1" (cp 28591),
        ...
        ///         <c>ProvisionalAlternateEncoding</c> to IBM437 before setting the
        ///         <see
        ///             cref="Comment" />
        ...
        public Encoding ProvisionalAlternateEncoding
        {
            get
            {
                if (AlternateEncodingUsage == ZipOption.AsNecessary)
        ...
        /// </summary>
        internal ZipOption AlternateEncodingUsage { get; set; } = ZipOption.Never;
        ...
        ///     </para>
        ///     <para>
        ///         When setting the Password, you may also want to explicitly set the
        ///         <see
        ///             cref="Encryption" />
        ...
        ///         <c>ZipFile</c>, then call one of the Extract() overloads on the
        ///         <see
        ///             cref="ZipEntry" />
        ///         . In this case, the entry is extracted using the
        ...
        ///     </para>
        ///     <para>
        ///         The <see cref="ZipEntry" /> class also has a
        ///         <see
        ///             cref="ZipEntry.Password">
        ///             Password
        ///         </see>
        ///         property.  It takes precedence
        ...
        public string Password
        {
            set
            {
                ...
                else if (Encryption == EncryptionAlgorithm.None) Encryption = EncryptionAlgorithm.PkzipWeak;
            }
        ...
        ///         <see
        ///             cref="Password" />
        ///         and <see cref="CompressionLevel" />, setting this
        ...
        /// <remarks>
        ///     <para>
        ///         Set this to a non-zero value before calling <see cref="Save()" /> or
        ///         <see
        ///             cref="Save(String)" />
        ///         to specify that the ZipFile should be saved as a
        ...
        /// <remarks>
        ///     <para>
        ///         This is normally zero, unless you have set the
        ///         <see
        ///             cref="MaxOutputSegmentSize" />
        ///         property.  If you have set
        ///         <see
        ///             cref="MaxOutputSegmentSize" />
        ///         , and then you save a file, after the call to
        ...
        {
            get { return unchecked((int)_numberOfSegmentsForMostRecentSave + 1); }
        }
        ...
        ///         of an advantage when using lower compression levels, for example
        ///         <see
        ///             cref="Zlib.CompressionLevel.BestSpeed" />
        ///         .  You may have to
        ...
        internal Stream StreamForDiskNumber(uint diskNumber)
        {
            if (diskNumber + 1 == _diskNumberWithCd ||
                ...
                return ReadStream;
            return ZipSegmentedStream.ForReading(_readName ?? Name,
        ...
        internal void Reset(bool whileSaving)
        {
            if (_JustSaved)
            {
                ...
                {
                    // workitem 10735
                    x._readName = x.Name = whileSaving
                        ? _readName ?? Name
                        : Name;
        ...
        ///     </para>
        ///     <para>
        ///         By the way, since DotNetZip is so easy to use, don't you think
        ///         <see
        ...
        /// <remarks>
        ///     <para>
        ///         This constructor works like the
        ///         <see cref="ZipFile(String)">
        ///             ZipFile
        ///             constructor that accepts a single string argument.
        ///         </see>
        ...
        ///         page.  This is a equivalent to setting the
        ///         <see
        ///             cref="ProvisionalAlternateEncoding" />
        ///         property on the <c>ZipFile</c>
        ///         instance after construction.
        ...
        ///         update a zip file by using the
        ///         <see cref="ZipFile()">
        ///             default (no argument)
        ///             constructor
        ///         </see>
        ///         , then calling <c>Initialize()</c> to read the contents
        ...
        ///         for forward slashes.  So,
        ///         <c>
        ///             zip["dir1\\entry1.txt"].FileName ==
        ///             "dir1/entry.txt"
        ///         </c>
        ///         .
        ///     </para>
        ...
        public ICollection<ZipEntry> EntriesSorted
        {
            get
            {
                ...
                foreach (var e in Entries) coll.Add(e);
        ...
        protected virtual void Dispose(bool disposeManagedResources)
        {
            if (!_disposed)
            {
                if (disposeManagedResources)
                {
                    ...
                    if (_temporaryFileName != null && Name != null)
        ...
        internal Stream ReadStream
        {
            ...
            {
                if (_readstream == null)
                    if (_readName != null || Name != null)
                    {
                        _readstream = File.Open(_readName ?? Name,
                            FileMode.Open,
                            FileAccess.Read,
        ...
        private Stream WriteStream
        {
            ...
            get
            {
                ...
                SharedUtilities.CreateAndOpenUniqueTempFile(TempFileFolder ?? Path.GetDirectoryName(Name),
                    out _writestream,
...
#pragma warning restore 649
    ...
    /// <remarks>
    ///     <para>
    ///         Designed many years ago, the
    ///         <see
    ///             href="http://www.pkware.com/documents/casestudies/APPNOTE.TXT">
    ///             original zip
    ///             specification from PKWARE
    ///         </see>
    ///         allowed for 32-bit quantities for the
    ...
    ///         Windows Explorer, use <c>Never</c>. If you set this property to
    ///         <see
    ///             cref="Zip64Option.Never" />
    ///         , and your application creates a zip that would
