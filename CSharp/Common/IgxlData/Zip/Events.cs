...
namespace IgxlData.Zip
{
    ...
    /// <remarks>
    ///     When you add an entry and specify a <c>WriteDelegate</c>, via
    ///     <see
    ///         cref="OfficeOpenXml.Packaging.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)" />
    ///     , the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="OfficeOpenXml.Packaging.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)" />
    ...
    ///   OpenDelegate, CloseDelegate)" />, the
    ///     application code provides the logic that
    ...
    ///     </para>
    /// </remarks>
    /// <seealso cref="OfficeOpenXml.Packaging.Ionic.Zip.ZipFile.SetCompression" />
    ...
    internal class ReadProgressEventArgs : ZipProgressEventArgs
    {
        ...
        internal static ReadProgressEventArgs ByteUpdate(string archiveName, ZipEntry entry, long bytesXferred,
            long totalBytes)
        {
    ...
    internal class SaveProgressEventArgs : ZipProgressEventArgs
    {
        ...
        internal SaveProgressEventArgs(string archiveName, bool before, int entriesTotal, int entriesSaved,
            ZipEntry entry)
            : base(archiveName,
                before ? ZipProgressEventType.Saving_BeforeWriteEntry : ZipProgressEventType.Saving_AfterWriteEntry)
        {
    ...
    internal class ExtractProgressEventArgs : ZipProgressEventArgs
    {
        ...
        internal static ExtractProgressEventArgs ExtractExisting(string archiveName, ZipEntry entry,
            string extractLocation)
        {
            var x = new ExtractProgressEventArgs
            {
        ...
        internal static ExtractProgressEventArgs AfterExtractEntry(string archiveName, ZipEntry entry,
            string extractLocation)
        {
            var x = new ExtractProgressEventArgs
            {
        ...
        internal static ExtractProgressEventArgs ExtractAllStarted(string archiveName, string extractLocation)
        {
            ...
            x.ExtractLocation = extractLocation;
            return x;
        }
