...
namespace SpreedSheet.Rendering
{
    ...
    internal sealed class BorderPainter : IDisposable
    {
        ...
        public static BorderPainter Instance
        {
            get
            {
                if (instance == null) instance = new BorderPainter();
        ...
        public void DrawLine(PlatformGraphics g, double x, double y, double x2, double y2, RangeBorderStyle style)
        {
        ...
        public void DrawLine(PlatformGraphics g, double x, double y, double x2, double y2, BorderLineStyle style,
