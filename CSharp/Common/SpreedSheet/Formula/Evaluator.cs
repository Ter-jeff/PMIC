				...
				case STNodeType.GREAT_THAN:
					{
						...
						{
							string str1 =
 (v1.type == FormulaValueType.String) ? (string)v1.value : Convert.ToString(v1.value);
							string str2 =
 (v2.type == FormulaValueType.String) ? (string)v2.value : Convert.ToString(v2.value);
...
#region TIME
					...
					dt =
 new DateTime(1900, 1, 1, (int)(double)args[0].value, (int)(double)args[1].value, (int)(double)args[2].value);
