...
namespace unvell.ReoGrid.Drawing
{
	...
	{
#if WINFORM
		internal System.Drawing.StringFormat sf =
 new System.Drawing.StringFormat(System.Drawing.StringFormat.GenericTypographic)
		{
			FormatFlags =
 System.Drawing.StringFormatFlags.NoWrap | System.Drawing.StringFormatFlags.MeasureTrailingSpaces,
		};
#endif // WINFORM
...
#region Add Text
		...
		public void AddText(string text, string fontName = null, RGFloat? fontSize = null, FontStyles? fontStyles =
 null,
		...
		/// <param name="backColor">Background color of text to be appended. Null to use last background color or default background color.</param>
		/// <returns>Rich format text instance.</returns>
		public RichText Span(string text, string fontName = null, RGFloat? fontSize = null, FontStyles? fontStyles =
 null,
			SolidColor? textColor = null, SolidColor? backColor = null)
		{
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Bold, textColor, backColor);
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Italic, textColor, backColor);
			lastRun.AppendText(text);
			return this;
		}
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Underline, textColor, backColor);
			lastRun.AppendText(text);
			return this;
		}
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Regular, textColor, backColor);
			lastRun.AppendText(text);
			return this;
		}
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Superscrit, textColor, backColor);
			lastRun.AppendText(text);
			return this;
		}
		...
		{
			var lastRun =
 this.GetOrCreateLastParagraph().GetOrCreateLastRun(fontName, fontSize, FontStyles.Subscript, textColor, backColor);
			lastRun.AppendText(text);
			return this;
		}
...
#elif WPF
						var gr =
 new System.Windows.Media.GlyphRun(b.FontInfo.GlyphTypeface, 0, false, r.FontSize * 1.33d,
...
#region Font Info
		...
		public FontStyles FontStyles { get { return this.fontStyles; } set { this.fontStyles = value; this.fontInfo =
 null; } }
