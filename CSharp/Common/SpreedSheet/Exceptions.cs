...
namespace unvell.ReoGrid
{
    ...
    /// <summary>
    ///     Exception is thrown when an reference as string neither is an valid address nor a registered name to locate a
    ///     range.
    /// </summary>
    [Serializable]
    ...
    public class OutlineIntersectedException : OutlineException
    {
        ...
        public OutlineIntersectedException()
            : base(
                "Specified outline intersects with another one. To group rows make sure that range of outline containing other outlines completely.")
        {
        }
    }

    /// <summary>
    ///     Exception thrown when adding an outline at specified position, but another outline has already exist at same
    ///     position.
    /// </summary>
    [Serializable]
    ...
    /// <summary>
    ///     Exception thrown when adding an outline at specified position, but the position is out of available range of
    ///     worksheet.
    /// </summary>
    [Serializable]
    ...
    public class PageBreakCannotRemoveException : ReoGridPrintException
    {
        ...
        public PageBreakCannotRemoveException(int index)
            : this("Page break at index " + index
                                          + " cannot be removed, spreadsheet must be have at least two page breaks in order to decide the printable range.",
                index)
        {
        }
