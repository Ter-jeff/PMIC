...
CustomSymbol = 0xf0
        ...
        public string FormatCell(Cell cell)
        {
            ...
            {
                var strdata = (data as string).Trim();
            ...
            if (isNumeric)
            {
                ...
                var arg = cell.DataFormatArgs as INumberFormatArgs;

                var numberPart = FormatNumberCellAndGetPattern(cell, ref value, arg);

                if (arg is NumberFormatArgs)
                {
                    var nargs = (NumberFormatArgs)cell.DataFormatArgs;
        ...
        internal static string FormatNumberCellAndGetPattern(Cell cell, ref double value, INumberFormatArgs arg)
        {
            ...
            var negativeStyle = NumberNegativeStyle.Default;
            ...
            // number
            var numberPart = (useSeparator ? "#,##0." : "0.") + decimalPlacePart;
            ...
            // negative
            if ((negativeStyle & NumberNegativeStyle.Minus) == 0) value = Math.Abs(value);
        ...
        public class NumberFormatArgs : INumberFormatArgs
        {
            ...
            {
                DecimalPlaces = 2;
                NegativeStyle = NumberNegativeStyle.Minus;
            }
            ...
            public override bool Equals(object obj)
            {
                ...
                var o = (NumberFormatArgs)obj;
                return DecimalPlaces == o.DecimalPlaces
                       && NegativeStyle == o.NegativeStyle
                       && UseSeparator == o.UseSeparator
                       && CustomNegativePrefix == o.CustomNegativePrefix
                       && CustomNegativePostfix == o.CustomNegativePostfix
                    ;
            }
