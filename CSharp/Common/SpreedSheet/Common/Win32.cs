...
namespace unvell.Common.Win32Lib
{
    public static class Win32
    {
        ...
        ///     <ul>
        ///         <li>The window is a top-level window that is unowned or does not have the WS_POPUP style.</li>
        ///         <li>The owner window has WS_POPUP style.</li>
        ///     </ul>
        /// </returns>
        ...
        public static extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInstertAfter, int x, int y, int cx, int cy,
            uint flags);
        ...
        public struct WindowPlacement
        {
            ...
            /// <summary>
            ///     The flags that control the position of the minimized window and the method by which the window is restored. This
            ///     member can be one or more of the following values.
            ///     Value	Meaning
            ///     WPF_ASYNCWINDOWPLACEMENT	0x0004	If the calling thread and the thread that owns the window are attached to different
            ///     input queues, the system posts the request to the thread that owns the window. This prevents the calling thread
            ///     from blocking its execution while other threads process the request.
            ///     WPF_RESTORETOMAXIMIZED		0x0002	The restored window will be maximized, regardless of whether it was maximized before
            ///     it was minimized. This setting is only valid the next time the window is restored. It does not change the default
        ...
        public enum DwmWindowAttribute
        {
            ...
            ///     DWM.
            ///     The pvAttribute parameter points to a value of TRUE to enable content rendered in the non-client area to be visible
            ///     on the frame; otherwise, it points to FALSE.
            /// </summary>
            DWMWA_ALLOW_NCPAINT,
