...
namespace MyWpf.Controls.Ribbon.UI
{
    ...
    public class Ribbon : TabControl
    {
        ...
        protected override bool IsItemItsOwnContainerOverride(object item)
        {
            ...
            {
                var content = ((UserControl)item).Content;
                if (content is RibbonTab)
                    return true;
            }
            return false;
        }
        ...
        public Visibility AppMenuVisibility
        {
            get { return (Visibility)GetValue(AppMenuVisibilityProperty); }
            set { SetValue(AppMenuVisibilityProperty, value); }
        }

        public static readonly DependencyProperty AppMenuVisibilityProperty =
            DependencyProperty.Register("AppMenuVisibility", typeof(Visibility), typeof(Ribbon), new PropertyMetadata(Visibility.Hidden));
        #endregion
