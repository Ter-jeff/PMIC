...
namespace IgxlData.Others
{
    public class SpecFormat
    {
        ...
        private const string SuffixPlus_UHv = "GLB_Plus_UHV";
        private const string SuffixMinus_ULv = "GLB_Minus_ULV";
        ...
        {
            return CreateSpecSymbol(pinName, SuffixMinus_ULv);
        }

        public static string GenGlbPlusUHv(string pinName)
        {
            return CreateSpecSymbol(pinName, SuffixPlus_UHv);
        }
