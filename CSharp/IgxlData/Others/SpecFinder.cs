...
namespace IgxlData.Others
{
    public class SpecFinder
    {
        ...
        public string GetValue(InstanceRow instanceRow, string formula)
        {
            ...
            if (_levelSheets.Exists(x => x.SheetName.Equals(instanceRow.PinLevels, StringComparison.CurrentCultureIgnoreCase)))
            {
                var levelSheet = _levelSheets.Find(x => x.SheetName.Equals(instanceRow.PinLevels, StringComparison.CurrentCultureIgnoreCase));
