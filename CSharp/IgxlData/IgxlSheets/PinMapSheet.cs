...
namespace IgxlData.IgxlSheets
{
    ...
    public class PinMapSheet : IgxlSheet
    {
        ...
        {
            List<Pin> pinList = PinList.FindAll(p => p.PinType.Equals(PinMapConst.TypePower, StringComparison.OrdinalIgnoreCase));
            return pinList;
        }

        public List<Pin> GetIoPins()
        {
            List<Pin> pinList = PinList.FindAll(p => p.PinType.Equals(PinMapConst.TypeIo, StringComparison.OrdinalIgnoreCase));
            return pinList;
        }
        ...
        {
            List<Pin> pinList = PinList.FindAll(p => p.ChannelType.Equals(PinMapConst.TypeIo, StringComparison.OrdinalIgnoreCase));
        ...
        public List<Pin> GetPinsFromGroup(string pinGroup)
        {
            ...
            List<Pin> pinOrGroup = GroupList.Find(p => p.PinName.Equals(pinGroup, StringComparison.OrdinalIgnoreCase)).PinList;
            foreach (var pin in pinOrGroup)
            {
                ...
                {
                    var singlePin = PinList.Find(p => p.PinName.Equals(pin.PinName, StringComparison.OrdinalIgnoreCase));
