...
namespace IgxlData.IgxlSheets
{
    public class AcSpecSheet : IgxlSheet
    {
        ...
        public List<AcSpecs> AcSpecs { get; set; }
        ...
        public AcSpecs AddAcSpecs(string symbol, string value, string typ, string min, string max)
        {
            //Write basic data
            var acSpecs = new AcSpecs(symbol, GetSelectorList(), value);
            //Write Category
            foreach (var category in CategoryList)
            {
