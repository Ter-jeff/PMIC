...
namespace IgxlData.IgxlSheets
{
    ...
    public class ChannelMapSheet : IgxlSheet
    {
        ...
        {
            IgxlWriter.WriteLine("DTChanMap,version=2.6:platform=Jaguar:toprow=-1:leftcol=-1:rightcol=-1:dataformat=signal\tChannel Map");
        ...
        {
            string viewMode = "";
            _isPogo = _channelData.Find(p => p.Sites.Exists(a => Regex.IsMatch(a, "ch", RegexOptions.IgnoreCase))) == null;
        ...
        protected override void WriteRows()
        {
            ...
            {
                IgxlWriter.Write("\t" + chanel.DeviceUnderTestPinName + "\t" + chanel.DeviceUnderTestPackagePin + "\t" + chanel.Type + "\t");
        ...
        private void Write2P4(string fileName, string version, SheetInfo igxlSheetsVersion)
        {
            ...
            using (var sw = new StreamWriter(fileName, false))
            {
                ...
                int relativeColumnIndex = siteIndex + _channelData.First().Sites.Count;
                ...
                for (var i = 1; i < startRow; i++)
                {
                    ...
                    if (igxlSheetsVersion.Columns.Variant != null)
                    {
                        foreach (var item in igxlSheetsVersion.Columns.Variant)
                        {
                            ...
                            {
                                for (int index = 0; index < _channelData.First().Sites.Count; index++)
