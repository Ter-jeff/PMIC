...
namespace IgxlData.IgxlSheets
{
    public class WaveDefinitionSheet : IgxlSheet
    {
        ...
        public override void Write(string fileName, string version)
        {
            ...
            {
                writer.WriteLine("\t{0}\t{1}\t{2}\t{3}\t{4}\t{5}\t{6}\t{7}\t{8}", waveDefRow.WaveDefName, waveDefRow.WaveDefType, waveDefRow.WaveDefComponent, waveDefRow.RepeatCount, waveDefRow.RelativePeriod, waveDefRow.RelativeAmplitude, waveDefRow.RelativeOffset, waveDefRow.PrimitiveParameters, waveDefRow.Comment);
            }
            writer.Close();
        }
