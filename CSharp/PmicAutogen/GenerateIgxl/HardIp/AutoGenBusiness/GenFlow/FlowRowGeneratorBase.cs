...
namespace PmicAutogen.GenerateIgxl.HardIp.AutoGenBusiness.GenFlow
{
    public abstract class FlowRowGeneratorBase
    {
        ...
        protected string BlockName { set; get; } = string.Empty;
        ...
        protected string SubBlockName => CommonGenerator.GetSubBlockName(Pat.Pattern.GetLastPayload(), Pat.MiscInfo,
            BlockName, Pat.ForceCondition.IsCz2InstName);
        ...
        public List<FlowRow> GenSweepCodeForRow()
        {
        ...
        protected void SortFlowRows(List<FlowRow> originFlowRows, List<FlowRow> sortedFlowRows)
        {
        ...
        //public List<FlowRow> AddExtraBinRows(FlowRow binRow)
        //{
        //    var results = new List<FlowRow>();
