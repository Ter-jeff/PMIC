...
namespace PmicAutogen.GenerateIgxl.Basic.Writer.GenLevel
{
    public class LevelMain
    {
        ...
        public List<LevelRow> CreatePowerPinLevels()
        {
            ...
            foreach (var row in _vddLevelsSheet.Rows)
            {
                ...
                else
                {
                    ...
                    if (pinType.Equals("DCVI", StringComparison.CurrentCultureIgnoreCase) || pinType.Equals("DCVIMerged", StringComparison.CurrentCultureIgnoreCase))
                    {
                        levelRows.AddRange(AddDcviPowerPinLevel(new DcviPowerLevel(pinName, vMain, iFoldLevel, tDelay)));
                    }
                    else
                    {
        ...
        {
            var levelRows = new List<LevelRow>();
            var bscanApplyPinsDomains = ioLevelsRows.Where(o => o.IsBscanApplyPins).Select(o => o.Domain).Distinct().ToList();
        ...
        public void GenPinGroup(IoLevelsSheet ioLevels)
        {
            ...
            foreach (var pinGroup in pinGroups)
            {
                ...
                if (pinMap.IsGroupExist(pinGroup.PinName))
                {
                    ...
                    EpplusErrorManager.AddError(BasicErrorType.Existential, ErrorLevel.Error, ioLevels.SheetName,
        ...
        private List<PinGroup> CreatePinGroup(IoLevelsSheet ioLevels)
        {
            ...
            List<PinGroup> bscanApplyPinGroups = ioLevels.GenBscanApplyPinGroups();
