...
namespace PmicAutogen.GenerateIgxl.OTP.Writer
{
    public class WriterOtpRegisterMap
    {
        ...
        public void OutPutOtpRegisterMap(string path, string sheetName, bool outputPath, bool bypassEditVbt = false)
        {
            ...
            {
                var index = 1;
                if (otpItem.OtpRegisterName != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.OtpRegisterName.ToUpper();
                if (otpItem.Name != null) otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.Name.ToUpper();
                if (otpItem.InstName != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.InstName.ToUpper();
                ...
                if (otpItem.DefaultValue != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.DefaultValue.ToUpper();
                ...
                if (otpItem.OtpRegAdd != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.OtpRegAdd.ToUpper();
                if (otpItem.OtpRegOfs != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.OtpRegOfs.ToUpper();
                if (otpItem.DefaultOrReal != null)
                    otpRegMapSheet.Cells[rowIndex, index++].Value = otpItem.DefaultOrReal;
                otpRegMapSheet.Cells[rowIndex, index++].Value = "";
                otpRegMapSheet.Cells[rowIndex, index++].Value = "";
                otpRegMapSheet.Cells[rowIndex, index++].Value = "";
                otpRegMapSheet.Cells[rowIndex, index++].Value = "0";
                foreach (var extraItem in otpItem.OtpExtra) otpRegMapSheet.Cells[rowIndex, index++].Value = extraItem;
                rowIndex++;
            }
