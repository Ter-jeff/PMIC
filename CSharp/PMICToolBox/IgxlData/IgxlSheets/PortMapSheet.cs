...
namespace IgxlData.IgxlSheets
{
    public class PortMapSheet : IgxlSheet
    {
        ...
        //{
        //    const string header = "DTPortMapSheet,version=2.0:platform=Jaguar:toprow=-1:leftcol=-1:rightcol=-1\tPort Map\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        ...
        //    IgxlWriter.WriteLine("\tPort Name\tFamily\tType\tSettings\tSetting0\tSetting1\tSetting2\tSetting3\tSetting4\tSetting5\tSetting6\tSetting7\tSetting8\tSetting9\tName\tPin\tProperties\tProperty0\tProperty1\tProperty2\tProperty3\tProperty4\tProperty5\tProperty6\tProperty7\tProperty8\tProperty9\tComment\t");
        //}
        ...
        //            //    row.Append("\t");
        //            //}
        //            for (int i = 0; i < PortRow.ConSettingNumber; i++)
        //            {
        //                if (port.ProtocolSettingValues.Count > i)
        //                {
        //                    row.Append(port.ProtocolSettingValues[i]);
        //                }
        //                else
        //                {
        //                    row.Append("");
        ...
        //            //    row.Append("\t");
        //            //}
        //            for (int i = 0; i < PortRow.ConProperityNumber; i++)
        //            {
        //                if (port.FunctionPropertyValues.Count > i)
        //                {
        //                    row.Append(port.FunctionPropertyValues[i]);
        //                }
        //                else
        //                {
        //                    row.Append("");
