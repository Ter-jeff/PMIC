...
namespace IgxlData.IgxlManager
{
    public class ManifestSheet
    {
        ...
        public Dictionary<string, List<ManifestSheetItem>> SubPrograms = new Dictionary<string, List<ManifestSheetItem>>();
        ...
        /*
            IG-Link Project File:	TMJQ51_Aruba.igxlProj,Teradyne.Oasis.IGLinkBase.DeviceJob,CP1_HIP	Generated to directory: D:\Aruba\Trunk	RelativePathToGeneratedLocation
            Export Disabled:	FALSE		
            Export Password:			
            ChanMapExport Mode:	Pogo		
            Prompt To Export:	TRUE		
            Sub Program	Source File	Imported Name	Other Info
         */
        ...
        public void UpdateManifestItemWithUnknownItem(string subprogram, string filename, string relatedPath, string fullPath)
        {
            var item = new ManifestSheetItem();
