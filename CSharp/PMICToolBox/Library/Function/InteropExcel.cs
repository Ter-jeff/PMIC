...
namespace Library.Function
{
    ...
    public static class InteropExcelExtensions
    {
        ...
        public static Worksheet AddSheet(this Workbook workbook, string name)
        {
            ...
            Worksheet newSheet = (Worksheet)
                workbook.Worksheets.Add(Type.Missing, workbook.Worksheets[1], Type.Missing, Type.Missing);
            newSheet.Name = name;
            return newSheet;
        }
            ...
            Expression<Func<T, string>> lambdaExpression) where T : new()
        {
            ...
            range.LoadColumnFromCollection(orderList);
        ...
        public static Range LoadRowFromCollection<T>(this Range range, IEnumerable<T> collection,
            bool printHeaders = true)
        {
            return LoadFromCollection(range, collection, true, printHeaders);
        }

        public static void LoadColumnFromCollection<T>(this Range range, IEnumerable<T> collection,
            bool printHeaders = true)
        {
        ...
        public static Range LoadRowFromArray(this Range range, IEnumerable<object[]> data,
            List<string> headerList = null)
        {
            return LoadFromArray(range, data, true, headerList);
        }

        public static Range LoadColumnFromArray(this Range range, IEnumerable<object[]> data,
            List<string> headerList = null)
        {
